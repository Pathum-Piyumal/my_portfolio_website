  ...
  return (
    <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto w-full relative z-10 overflow-hidden" id="honors">
      ...
      >
        ...
        <div className="relative group overflow-hidden bg-zinc-950/40 border border-white/5 rounded-3xl p-8 md:p-12 backdrop-blur-md transition-all duration-300 hover:bg-zinc-950/60 hover:border-white/10 shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
            <div className="flex gap-6 items-start">
              <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 group-hover:border-amber-500/40 shadow-[0_0_20px_rgba(245,158,11,0.15)] group-hover:shadow-[0_0_30px_rgba(245,158,11,0.25)] transition-all duration-500 shrink-0">
            ...
            <div className="flex flex-col gap-2 bg-black/40 border border-white/5 rounded-2xl p-6 min-w-[200px] shrink-0 font-mono text-xs text-zinc-400">
